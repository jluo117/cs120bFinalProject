...
def Test_Lines():
    ...
    for x in range(0, (OLED.SSD1351_WIDTH-1)/2, 6):
    ...
    for x in range(0, (OLED.SSD1351_WIDTH-1)/2, 6):
        ...
        draw.line([(OLED.SSD1351_WIDTH - 1, 0), (x + (OLED.SSD1351_WIDTH-1)/2, OLED.SSD1351_HEIGHT - 1)], fill = "YELLOW", width = 1)
        draw.line([(OLED.SSD1351_WIDTH - 1, 0), (0, x)], fill = "YELLOW", width = 1)
        draw.line([(OLED.SSD1351_WIDTH - 1, 0), (0, x + (OLED.SSD1351_HEIGHT-1)/2)], fill = "YELLOW", width = 1)
        OLED.Display_Image(image)
    OLED.Delay(250)
    draw.rectangle([0, 0, OLED.SSD1351_WIDTH - 1, OLED.SSD1351_HEIGHT - 1], fill = "BLACK", outline = "BLACK")
    ...
    for x in range(0, (OLED.SSD1351_WIDTH-1)/2, 6):
        ...
        draw.line([(0, OLED.SSD1351_HEIGHT - 1), (x + (OLED.SSD1351_WIDTH-1)/2, 0)], fill = "BLUE", width = 1)
    ...
    for x in range(0, (OLED.SSD1351_WIDTH-1)/2, 6):
        ...
        draw.line([(OLED.SSD1351_WIDTH - 1, OLED.SSD1351_HEIGHT - 1), (x + (OLED.SSD1351_WIDTH-1)/2, 0)], fill = "GREEN", width = 1)
        draw.line([(OLED.SSD1351_WIDTH - 1, OLED.SSD1351_HEIGHT - 1), (0, x)], fill = "GREEN", width = 1)
        draw.line([(OLED.SSD1351_WIDTH - 1, OLED.SSD1351_HEIGHT - 1), (0, x + (OLED.SSD1351_HEIGHT-1)/2)], fill = "GREEN", width = 1)
        OLED.Display_Image(image)
...
def Test_FillRects(): 
    ...
    for x in range(OLED.SSD1351_HEIGHT-1, (OLED.SSD1351_HEIGHT-1)/2, -6):
...
def Test_Circles():
    ...
    OLED.Display_Image(image)
    OLED.Delay(500)
    for r in range(0, OLED.SSD1351_WIDTH/2 + 4, 4):
...
def Test_Triangles():
    ...
    for i in range(0, OLED.SSD1351_WIDTH/2, 4):
